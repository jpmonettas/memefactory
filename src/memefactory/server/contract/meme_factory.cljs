...
(defn create-meme-data [{:keys [:creator :image-hash :title :total-supply]}]
  (web3-eth/contract-get-data (instance :meme-factory) :create-meme creator image-hash total-supply title))
